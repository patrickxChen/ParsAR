...
namespace GoogleTextToSpeech.Scripts
{
    public class AudioConverter : MonoBehaviour
    {
        ...
        private static IEnumerator LoadClipFromMp3Cor(Action<AudioClip> onClipLoaded)
        {
            ...
            {
                Debug.Log($"AudioConverter: loaded mp3 from {Application.temporaryCachePath}/{Mp3FileName} size={new System.IO.FileInfo(Application.temporaryCachePath + "/" + Mp3FileName).Length} bytes");
